...
public class ChangeLog extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strChange = ""
                ...
                "<h2>1.2.1</h2>"
                + "- Change: Feedback only for paid versions (sorry, i am getting too spammed, but want to provide easy feedback for paid users)<br/>"
                + "- Removed: Send list of services running for feedback, because after Android 2.2 that does not really help anymore<br/>"
                + "- Update: New AdMob SDK<br/>"
                + "- Fix: Better pause broadcast (hopefully)<br/>"
                +
                ...
                "<h2>0.7.1</h2>" + "- Added support for MixZing player (thx to gal)<br/>" +

                "<h2>0.7</h2>" + "- Added button to start Music player (thx to Christopher)<br/>"
                + "- Added settings<br/>" + "-- Turn off WiFi as option<br/>"
                + "-- Mute notifications (thx to dunn)<br/>" + "-- Set music player<br/>" +

                "<h2>0.6</h2>" + "- Added support for nswplayer (thx to farraguas)<br/>"
                + "- New way to choose the amount of minutes<br/>"
                + "- Set amount of minutes will be remembered<br/>"
                + "- Fixed: Bug with Hero lock screen<br/>" +

                "<h2>0.5.1</h2>" + "- Fixed: force close bug<br/>" +

                "<h2>0.5</h2>" + "- Small changes to interface<br/>"
                + "- Automatic sending bug report of force closes<br/>" +

                "<h2>0.4</h2>" + "- Improved Feedback (include running services)<br/>"
                + "- Choose Service to kill (like unsupported player)<br/>"
                + "- New players supported:<br/>" + "-- Google Listen support<br/>"
                + "-- TuneWiki support<br/>" + "-- Imeem support<br/>" + "-- Meridian support<br/>"
                + "-- Last.fm support<br/>" + "-- RockOn Lite support<br/>"
                + "-- Pandora support (untested)<br/>" + "-- Beyondpod support (untested)<br/>"
                + "-- Mediafly support (untested)<br/>" + "-- Doggcatcher support (untested)<br/>"
                + "-- Mixzing support (untested)<br/>" + "-- Droidlive support (untested)<br/>" +

                "<h2>0.3</h2>" + "- HTC Music Player support<br/>"
                + "- Streamfurious Lite support (and plus?)<br/>"
                + "- Feedback (bugs/requests) through e-mail<br/>" +

                "<h2>0.2</h2>" + "- Updated User Interface<br/>" + "- Added changelog<br/>"
                + "- Internal improvement in source code<br/>" +

                "<h2>0.1</h2>" + "- Stopping player<br/>" + "- Fade out<br/>"
